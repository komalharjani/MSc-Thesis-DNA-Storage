...
function onSubmit() {
    ...
    let ret = errorCorrectRedundant(cloneError, dnaStringError, cloneTwoError);
    let ret2 = dnaToBinary(ret);
    removePrimers(ret2);
    let extractedLength = getLength(ret2); //call getLength from here
