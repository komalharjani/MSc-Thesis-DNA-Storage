...
//let noErrors = 2;
var noErrors = document.getElementById("myRange");
var output = document.getElementById("demo");
output.innerHTML = noErrors.value; // Display the default slider value
noErrors.oninput = function() {
...
function simulate() {
        let addedPrimers = onConvert();

        //ERROR SIMULATOR
        let cloneOne = res.slice();
        let cloneTwo = res.slice();
