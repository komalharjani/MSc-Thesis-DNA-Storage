...
function errorSimulator(dnaString) { //does this have to deal with a string?
    ...
    //Percentage Split == Equal -- this is not needed
     let percentInsert;
     let percentDelete;
     let percentSub;
    ...
    if(del && insert && sub) {
        noInsertLoop = noErrors/3/noRunsInsert;
        noDeleteLoop = noErrors/3/noRunsDelete;
        noSubLoop = noErrors/3/noRunsSub;
    }
    else if(del && sub) {
        ...
        noDeleteLoop = noErrors/2/noRunsInsert;
        noInsertLoop = noErrors/2/noRunsDelete;
    }
