...
function onConvert() {
    ...
    dnaStringOutput = dnaStringOutput.join("");

    document.getElementById("dnaOutput").innerHTML = dnaStringOutput;
    ...
    if (original) {
        ...
        let dnaStringError = errorSimulator(dnaStringOutput);
