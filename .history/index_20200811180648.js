...
function addRedundancy(dnaString) {
    ...
    coverageCorrection(cloneError, dnaStringError, cloneTwoError);
}
 ...
 * @param {*} dnaString 
 */
function coverageCorrection(cloneOne, errorDNA, cloneTwo) {
    ...
    // while (state) {
    //     redundantCopy(cloneOne, cloneTwo, errorDNA);
    // }
}
...
function runSimulation() {
    ...
    addRedundancy(dnaString);
    addComplement(dnaArray);
    //after error simulator
    coverageCorrection(cloneError, dnaStringError, cloneTwoError); //redundancy correction
    //length correction
    //primer correction
