...
function onConvert() {
    ...
    if (original) {
        ...
        newLabel.textContent = "Original Copies: ";
        ...
        dnaOutput.textContent = dnaStringOutput.join("");
    ...
    if (comp) {
        ...
        let newPara = document.createElement('p');
        let newLabel = document.createElement('label');
        newLabel.textContent = "Complement Copies: ";
        document.getElementById("recoveredData").appendChild(newLabel);
        newPara.textContent = fin;
        document.getElementById("recoveredData").appendChild(newPara);
        ...
        //Display DNA
        let dnaOutput = document.createElement('p');
        dnaOutput.textContent = compCloneOne.join("");
        document.getElementById("dnaOutput").appendChild(newLabel);
        document.getElementById("dnaOutput").appendChild(dnaOutput);
    ...
    if (rev) {
        ...
        let newPara = document.createElement('p');
        let newLabel = document.createElement('label');
        newLabel.textContent = "Reverse Copies: ";
        document.getElementById("recoveredData").appendChild(newLabel);
        newPara.textContent = fin;
        document.getElementById("recoveredData").appendChild(newPara);
        ...
        //Display DNA
        let dnaOutput = document.createElement('p');
        dnaOutput.textContent = addedPrimersRev.join("");
        document.getElementById("dnaOutput").appendChild(newLabel);
        document.getElementById("dnaOutput").appendChild(dnaOutput);
...
function errorCorrectRedundant(errorDNA, cloneOne, cloneTwo, len) {
    ...
    if(extractedLength > getLenClone.length) {
        noErrors = (extractedLength - getLenClone.length) * 3;
    }
    else {
        let noDelete = getLenClone.length - extractedLength;
