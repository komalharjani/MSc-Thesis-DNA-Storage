...
function errorCorrection(cloneError,dnaStringError) {
    ...
    let difference = cloneError
                 .filter(x => !dnaStringError.includes(x))
                 .concat(dnaStringError.filter(x => !cloneError.includes(x)));

    console.log(difference);

    let diffe = dnaStringError.filter(i => !cloneError.includes(i));
    console.log(diffe);
