...
function removeRandomLetter(str) {
    let onePerc = Math.round(dnaString.length * 0.01);
    let fivePerc = Math.round(dnaString.length * 0.05);
    console.log(onePerc);
    console.log(fivePerc);
    //generat
    //let number = find 1% of length
    //create loop
    //generate number x of random index positions
    //remove from array
